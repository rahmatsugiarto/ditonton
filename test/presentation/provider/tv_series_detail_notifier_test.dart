...
void main() {
  ...
  group('Get Tv Series Detail', () {
    ...
    test(
      ...
      // assert
      expect(provider.tvSeriesState, RequestState.Loaded);
      expect(provider.tvSeriesRecommendations, tListTvSeries);
    });
  });
  ...
  group('Watchlist', () {
    ...
    test('should execute remove watchlist when function success called', () async {
      // arrange
    ...
    test('should execute remove watchlist when function failed called', () async {
      // arrange
      when(mockRemoveWatchlistTvSeries.execute(testTvSeriesDetail))
